...
namespace Astrana.Core.Data.Migrations.MSSqlServer.Migrations
{
    ...
    [Migration("20240329055512_ExternalContentSubscription3")]
    partial class ExternalContentSubscription3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Astrana.Core.Data.Entities.Configuration.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SettingCategoryId = new Guid("f71b0459-44ab-499e-b5d7-afca31ab19b5"),
                        ...
                        new
                        {
                            ...
                            SettingCategoryId = new Guid("7dc564b5-9cc9-459e-987a-695fbfcab4a0"),
            ...
            modelBuilder.Entity("Astrana.Core.Data.Entities.Content.ExternalContentSubscription", b =>
                {
                    b.HasOne("Astrana.Core.Data.Entities.Content.Image", "CoverImage")
                        .WithMany()
                        .HasForeignKey("CoverImageId");

                    b.HasOne("Astrana.Core.Data.Entities.Content.Image", "IconImage")
                        .WithMany()
                        .HasForeignKey("IconImageId");

                    b.HasOne("Astrana.Core.Data.Entities.Content.Image", "LogoImage")
                        .WithMany()
