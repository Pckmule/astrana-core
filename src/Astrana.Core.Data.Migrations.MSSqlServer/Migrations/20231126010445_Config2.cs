    ...
    public partial class Config2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CreatedTimestamp", "LastModifiedTimestamp" },
                values: new object[] { new DateTimeOffset(new DateTime(2023, 11, 26, 1, 4, 44, 315, DateTimeKind.Unspecified).AddTicks(9348), new TimeSpan(0, 0, 0, 0, 0)), new DateTimeOffset(new DateTime(2023, 11, 26, 1, 4, 44, 315, DateTimeKind.Unspecified).AddTicks(9348), new TimeSpan(0, 0, 0, 0, 0)) });
