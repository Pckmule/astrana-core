...
{
    public class AddProfilePictureCommand : IAddProfilePictureCommand
    {
        private readonly ILogger<AddProfilePictureCommand> _logger;
        ...
        public AddProfilePictureCommand(ILogger<AddProfilePictureCommand> logger, IUploadImageCommand uploadImageCommand, IUserProfileRepository<Guid> userProfileRepository)
        {
            _logger = logger;
        ...
        public async Task<AddResult<Image>> ExecuteAsync(Guid profileId, IFormFile imageFile, Guid actioningUserId)
        {
            ...
            var result = await _userProfileRepository.UpdateProfilePictureAsync(profileId, uploadResult.Data.First().ImageId, actioningUserId);
