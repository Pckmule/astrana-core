...
{
    public class UpdatePostsCommandHandler : IUpdatePostsCommandHandler
    {
        private readonly ILogger<UpdatePostsCommandHandler> _logger;
        private readonly IPostRepository<Guid> _postRepository;

        public UpdatePostsCommandHandler(ILogger<UpdatePostsCommandHandler> logger, IPostRepository<Guid> postRepository)
        {
            _logger = logger;
