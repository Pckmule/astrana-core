...
namespace Astrana.Core.Data.EntityConfiguration
{
    ...
    {
        public static ModelBuilder ConfigurePost(this ModelBuilder modelBuilder)
        {
            return modelBuilder.ApplyConfiguration(new PostConfiguration());
        }
    }
    ...
    public class PostConfiguration : IEntityTypeConfiguration<Post>
    {
        public void Configure(EntityTypeBuilder<Post> entityTypeBuilder)
        {
            entityTypeBuilder.Property(p => p.Text)
                .HasMaxLength(DomainModelProperties.Post.MaximumTextLength)
                .HasColumnOrder(1);

            //entityTypeBuilder.Property(p => p.Attachments)
            //    .HasColumnOrder(2);
