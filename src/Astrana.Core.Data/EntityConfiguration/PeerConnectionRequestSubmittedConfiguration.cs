...
namespace Astrana.Core.Data.EntityConfiguration
{
    ...
    {
        public static ModelBuilder ConfigurePeerConnectionRequestSubmitted(this ModelBuilder modelBuilder)
        {
            return modelBuilder.ApplyConfiguration(new PeerConnectionRequestSubmittedConfiguration());
        }
    }
    ...
    public class PeerConnectionRequestSubmittedConfiguration : IEntityTypeConfiguration<PeerConnectionRequestSubmitted>
    {
        public void Configure(EntityTypeBuilder<PeerConnectionRequestSubmitted> entityTypeBuilder)
        {
            entityTypeBuilder.Property(p => p.FirstName)
                .IsRequired()
                .HasMaxLength(DomainModelProperties.PeerConnectionRequestSubmitted.MaximumFirstNameLength)
                .HasColumnOrder(1);

            entityTypeBuilder.Property(p => p.LastName)
                .IsRequired()
                .HasMaxLength(DomainModelProperties.PeerConnectionRequestSubmitted.MaximumLastNameLength)
                .HasColumnOrder(2);
            ...
            entityTypeBuilder.Property(p => p.Address)
                .IsRequired()
                .HasMaxLength(DomainModelProperties.PeerConnectionRequestSubmitted.MaximumAddressLength)
                .HasColumnOrder(5);
            ...
            entityTypeBuilder.Property(p => p.PeerPreviewAccessToken)
                .HasMaxLength(DomainModelProperties.PeerConnectionRequestSubmitted.MaximumPeerPreviewAccessTokenLength)
                .HasColumnOrder(7);
