...
namespace Astrana.Core.Data.EntityConfiguration
{
    ...
    {
        public static ModelBuilder ConfigurePhoneNumber(this ModelBuilder modelBuilder)
        {
            return modelBuilder.ApplyConfiguration(new PhoneNumberConfiguration());
        }
    }

    public class PhoneNumberConfiguration : IEntityTypeConfiguration<PhoneNumber>
    {
        public void Configure(EntityTypeBuilder<PhoneNumber> entityTypeBuilder)
        {
            entityTypeBuilder.Property(p => p.Number)
                .IsRequired()
                .HasMaxLength(DomainModelProperties.PhoneNumber.MaximumNumberLength)
                .HasColumnOrder(1);
