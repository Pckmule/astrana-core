...
namespace Astrana.Core.Data.EntityConfiguration
{
    ...
    {
        public static ModelBuilder ConfigureReactionTemplate(this ModelBuilder modelBuilder)
        {
            return modelBuilder.ApplyConfiguration(new ReactionTemplateConfiguration());
        }
    }

    public class ReactionTemplateConfiguration : IEntityTypeConfiguration<ReactionTemplate>
    {
        public void Configure(EntityTypeBuilder<ReactionTemplate> entityTypeBuilder)
        {
