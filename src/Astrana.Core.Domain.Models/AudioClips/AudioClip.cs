...
{
    public sealed class AudioClip : DomainEntity<Guid, AudioDto>, IAudio, IAuditable<Guid>, IDeactivatable<Guid>
    {
        public AudioClip()
        {
        ...
        public AudioClip(AudioDto dto) : this()
        {
            if (dto == null)
                throw new ArgumentNullException(nameof(dto));

            if (dto.Id.HasValue)
                AudioClipId = dto.Id.Value;
        ...
        public AudioClip(AudioToAddDto dto) : this()
        {
            if (dto == null)
                throw new ArgumentNullException(nameof(dto));
