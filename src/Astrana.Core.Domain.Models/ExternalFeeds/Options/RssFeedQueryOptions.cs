...
{
    public class RssFeedQueryOptions<TRecordId, TOwnerUserId> : QueryOptions<TRecordId, TOwnerUserId>, MainFeed.Options.IMainFeedQueryOptions
        where TRecordId : struct
        where TOwnerUserId : struct
    {
        [JsonConstructor]
        public RssFeedQueryOptions() { }

        public RssFeedQueryOptions(List<TRecordId> ids) : base(ids) { }
