...
{
    public class PostQueryOptions<TRecordId, TOwnerUserId> : QueryOptions<TRecordId, TOwnerUserId>, IPostQueryOptions
        ...
        where TOwnerUserId : struct
    {
        ...
        public PostQueryOptions(List<TRecordId> ids) : base(ids) { }
