...
namespace Astrana.Core.Domain.Models.MainFeed.Options
{
    public class MainFeedQueryOptions<TRecordId, TOwnerUserId> : QueryOptions<TRecordId, TOwnerUserId>, IMainFeedQueryOptions
        where TRecordId : struct
        where TOwnerUserId : struct
    {
        [JsonConstructor]
        public MainFeedQueryOptions() { }

        public MainFeedQueryOptions(List<TRecordId> ids) : base(ids) { }
